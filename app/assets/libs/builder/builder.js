...
Vvveb.Builder = {
    ...
    _frameLoaded: function() {
        ...
        self.frameBody = $(window.FrameDocument).find("main");
        self.frameBody = $(window.FrameDocument).find(".container");
        self.frameBody = $(window.FrameDocument).find(".theme-classic");
        self.frameBody = $(window.FrameDocument).find(".col-12");
        self.frameBody = $(window.FrameDocument).find("form");
