...
Vvveb.Components.extend("_base", "html/jumbotron", {
    ...
    html: '<div class="jumbotron">\
		  ...
		  <p class="lead">\
			<a class="btn btn-lg btn-success" href="#" role="button">Ut enim ad minim veniam</a>\
		  </p>\
		</div>'
});
